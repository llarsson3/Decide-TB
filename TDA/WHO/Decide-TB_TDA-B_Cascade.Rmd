...
k <- subset(sub10, Sum_B > 10 & MTb_result == "MTB Negative" & TBContact == "No" & dangersigns == "No") %>% summarise(k = n())
l <- subset(sub10, Sum_B <= 10 & MTb_result == "MTB Negative" & TBContact == "No" & dangersigns == "No") %>% summarise(l = n())
...
# 1. Microbiology
distribution_mtb_positive <- prop.table(table(sub10$DiagnClass_NIH2015[sub10$MTb_result == "MTB Positive"]))
print("Distribution for Mtb positives")
print(distribution_mtb_positive)

# 2. TB contact
distribution_mtb_negative_contact_yes <- prop.table(table(sub10$DiagnClass_NIH2015[sub10$MTb_result == "MTB Negative" & sub10$TBContact == "Yes"]))
print("Distribution for TB contacts:")
print(distribution_mtb_negative_contact_yes)

# 3. Score
distribution_mtb_negative_contact_no_SumB_Bin_yes <- prop.table(table(sub10$DiagnClass_NIH2015[sub10$MTb_result == "MTB Negative" & sub10$TBContact == "No" & sub10$SumB_Bin == ">10"]))
print("Distribution for Sum > 10")
print(distribution_mtb_negative_contact_no_SumB_Bin_yes)

# 4. Treatment initiation
distribution_txinit <- prop.table(table(sub10$DiagnClass_NIH2015[sub10$TxInitiation_B == "Yes"]))
...
h <- subset(umoya_sub10, MTb_result == "MTB Negative" & dangersigns == "No") %>% summarise(h = n())
i <- subset(umoya_sub10, TBContact == "Yes" & MTb_result == "MTB Negative" & dangersigns == "No") %>% summarise(i = n())
j <- subset(umoya_sub10, TBContact == "No" & MTb_result == "MTB Negative" & dangersigns == "No") %>% summarise(j = n())
k <- subset(umoya_sub10, Sum_B > 10 & MTb_result == "MTB Negative" & TBContact == "No" & dangersigns == "No") %>% summarise(k = n())
l <- subset(umoya_sub10, Sum_B <= 10 & MTb_result == "MTB Negative" & TBContact == "No" & dangersigns == "No") %>% summarise(l = n())
...
# Diagnostic classifications by stage
# 1. Microbiology
distribution_mtb_positive <- prop.table(table(umoya_sub10$DiagnClass_NIH2015[umoya_sub10$MTb_result == "MTB Positive"]))
print("Distribution for Mtb positives")
print(distribution_mtb_positive)

# 2. TB contact
distribution_mtb_negative_contact_yes <- prop.table(table(umoya_sub10$DiagnClass_NIH2015[umoya_sub10$MTb_result == "MTB Negative" & umoya_sub10$TBContact == "Yes"]))
print("Distribution for TB contacts:")
print(distribution_mtb_negative_contact_yes)

# 3. Score
distribution_mtb_negative_contact_no_SumB_Bin_yes <- prop.table(table(umoya_sub10$DiagnClass_NIH2015[umoya_sub10$MTb_result == "MTB Negative" & umoya_sub10$TBContact == "No" & umoya_sub10$SumB_Bin == ">10"]))
print("Distribution for Sum > 10")
print(distribution_mtb_negative_contact_no_SumB_Bin_yes)

# 4. Treatment initiation
distribution_txinit <- prop.table(table(umoya_sub10$DiagnClass_NIH2015[umoya_sub10$TxInitiation_B == "Yes"]))
print("Distribution for treatment initiation")
print(distribution_txinit)
```
...
h <- subset(rapaed_sub10, MTb_result == "MTB Negative" & dangersigns == "No") %>% summarise(h = n())
i <- subset(rapaed_sub10, TBContact == "Yes" & MTb_result == "MTB Negative" & dangersigns == "No") %>% summarise(i = n())
j <- subset(rapaed_sub10, TBContact == "No" & MTb_result == "MTB Negative" & dangersigns == "No") %>% summarise(j = n())
k <- subset(rapaed_sub10, Sum_B > 10 & MTb_result == "MTB Negative" & TBContact == "No" & dangersigns == "No") %>% summarise(k = n())
l <- subset(rapaed_sub10, Sum_B <= 10 & MTb_result == "MTB Negative" & TBContact == "No" & dangersigns == "No") %>% summarise(l = n())
...
# Diagnostic classifications by stage
# 1. Microbiology
distribution_mtb_positive <- prop.table(table(rapaed_sub10$DiagnClass_NIH2015[rapaed_sub10$MTb_result == "MTB Positive"]))
print("Distribution for Mtb positives")
print(distribution_mtb_positive)

# 2. TB contact
distribution_mtb_negative_contact_yes <- prop.table(table(rapaed_sub10$DiagnClass_NIH2015[rapaed_sub10$MTb_result == "MTB Negative" & rapaed_sub10$TBContact == "Yes"]))
print("Distribution for TB contacts:")
print(distribution_mtb_negative_contact_yes)

# 3. Score
distribution_mtb_negative_contact_no_SumB_Bin_yes <- prop.table(table(rapaed_sub10$DiagnClass_NIH2015[rapaed_sub10$MTb_result == "MTB Negative" & rapaed_sub10$TBContact == "No" & rapaed_sub10$SumB_Bin == ">10"]))
print("Distribution for Sum > 10")
print(distribution_mtb_negative_contact_no_SumB_Bin_yes)

# 4. Treatment initiation
distribution_txinit <- prop.table(table(rapaed_sub10$DiagnClass_NIH2015[rapaed_sub10$TxInitiation_B == "Yes"]))
print("Distribution for treatment initiation")
print(distribution_txinit)
```
...
sub10 %>% 
  ...
  ggplot(aes(x = fct_rev(Sum_required), y = Sum_B)) + 
  ggdist::stat_halfeye(
...
sub10 %>% 
  ...
  group_by(Treatment) %>% 
  ggplot(aes(x = fct_rev(Treatment), y = Sum_B)) + 
  ggdist::stat_halfeye(
    aes(color = Treatment,
        fill = after_scale(lighten(color, .5))),
    adjust = .4, 
  ...
  labs(
    x = NULL,
    y = "Score",
    title = "Distribution of overall sum by clinician treatment decision",
  ) + 
  coord_flip(xlim = c(1.2, NA), clip = "off") +
  annotate("text", x=2.5, y=-4.5, label= "*", color="white") +
  stat_summary(
...
sub10 %>% 
  ...
  ggplot(aes(x = fct_rev(DiagnClass_NIH2015), y = Sum_B)) + 
  ggdist::stat_halfeye(
...
sub10 %>% 
  filter(Sum_required == "Yes") %>%
  group_by(study) %>% 
  ggplot(aes(x = fct_rev(study), y = Sum_B)) + 
  ggdist::stat_halfeye(
    aes(color = study,
        fill = after_scale(lighten(color, .5))),
    adjust = .4, 
  ...
  labs(
    x = NULL,
    y = "Score",
    title = "Distribution of overall sum by study",
  ) + 
  coord_flip(xlim = c(1.2, NA), clip = "off") +
  annotate("text", x=2.5, y=-4.5, label= "*", color="white") +
  stat_summary(
...
sub10 %>% 
  ...
  ggplot(aes(x = fct_rev(age_cat_ext), y = Sum_B)) + 
  ggdist::stat_halfeye(
  ...
  labs(
    x = NULL,
    y = "Score",
    title = "Distribution of overall sum by age category",
  ) + 
  coord_flip(xlim = c(1.2, NA), clip = "off") +
  annotate("text", x=2.5, y=-4.5, label= "*", color="white") +
  stat_summary(
...
sub10 %>% 
  filter(Sum_required == "Yes") %>%
  group_by(sam) %>% 
  ggplot(aes(x = fct_rev(sam), y = Sum_B)) + 
  ggdist::stat_halfeye(
    aes(color = sam,
        fill = after_scale(lighten(color, .5))),
    adjust = .4, 
  ...
  labs(
    x = NULL,
    y = "Score",
    title = "Distribution of overall sum by nutritional status (SAM)",
  ) + 
  coord_flip(xlim = c(1.2, NA), clip = "off") +
  annotate("text", x=2.5, y=-4.5, label= "*", color="white") +
  stat_summary(
...
sub10 %>% 
  filter(Sum_required == "Yes") %>%
  group_by(hivstatus) %>% 
  ggplot(aes(x = fct_rev(hivstatus), y = Sum_B)) + 
  ggdist::stat_halfeye(
    aes(color = hivstatus,
        fill = after_scale(lighten(color, .5))),
    adjust = .4, 
  ...
  labs(
    x = NULL,
    y = "Score",
    title = "Distribution of overall sum by HIV status",
  ) + 
  coord_flip(xlim = c(1.2, NA), clip = "off") +
  annotate("text", x=2.5, y=-4.5, label= "*", color="white") +
  stat_summary(
...
```{r}
sub10 <- sub10 %>% mutate(
  OutcomeScore = case_when(Sum_B > 10 ~ 1, Sum_B <= 10 ~ 0),
  OutcomeTDA = if_else(TxInitiation_B == "Yes", 1, 0))
```
...
r_all = roc(sub10$CRS, sub10$Sum_B)
r_nomicro = roc(nomicro$CRS, nomicro$Sum_B)
r_sumreq = roc(sub10_sumreq$CRS, sub10_sumreq$Sum_B)
...
r_rapaed = roc(rapaed_sub10_sumreq$CRS, rapaed_sub10_sumreq$Sum_B)
r_umoya = roc(umoya_sub10_sumreq$CRS, umoya_sub10_sumreq$Sum_B)
...
r_high = roc(highrisk_sumreq$CRS, highrisk_sumreq$Sum_B)
r_low = roc(lowrisk_sumreq$CRS, lowrisk_sumreq$Sum_B)
...
r_sub10 = roc(sub10_sumreq$CRS, sub10_sumreq$Sum_B)
r_all = roc(decide_sumreq$CRS, decide_sumreq$Sum_B)
r_less2 = roc(less2_sumreq$CRS, less2_sumreq$Sum_B)
r_2to10 = roc(twoto10_sumreq$CRS, twoto10_sumreq$Sum_B)
r_more10 = roc(more10_sumreq$CRS, more10_sumreq$Sum_B)
...
r_all = roc(sub10$CD, sub10$Sum_B)
r_nomicro = roc(nomicro$CD, nomicro$Sum_B)
r_sumreq = roc(sub10_sumreq$CD, sub10_sumreq$Sum_B)
...
r_rapaed = roc(rapaed_sub10_sumreq$CD, rapaed_sub10_sumreq$Sum_B)
r_umoya = roc(umoya_sub10_sumreq$CD, umoya_sub10_sumreq$Sum_B)
...
r_high = roc(highrisk_sumreq$CD, highrisk_sumreq$Sum_B)
r_low = roc(lowrisk_sumreq$CD, lowrisk_sumreq$Sum_B)
...
r_sub10 = roc(sub10_sumreq$CD, sub10_sumreq$Sum_B)
r_all = roc(decide_sumreq$CD, decide_sumreq$Sum_B)
r_less2 = roc(less2_sumreq$CD, less2_sumreq$Sum_B)
r_2to10 = roc(twoto10_sumreq$CD, twoto10_sumreq$Sum_B)
r_more10 = roc(more10_sumreq$CD, more10_sumreq$Sum_B)
