...
```{r, include=FALSE}
# Import data
load("/users/leylasophielarsson/Desktop/Studies/Decide-TB/Analysis/Data/Decide-TB_Dataset_yesNS.Rda")
...
Studies <- data.frame(TP=c(333,183,230,98), FN=c(31,34,20,24), FP=c(288,151,106,37), TN=c(88,106,112,45))
...
```{r}
# Generate the dataframe needed
Studies <- data.frame(TP=c(3348,187,238,122), FN=c(16,30,12,0), FP=c(319,169,155,77), TN=c(57,88,63,5))
Studies$names <- c("RaPaed","UMOYA","Cohort","HIV")
...
pdf("/Users/leylasophielarsson/Desktop/Studies/Decide-TB/Plots/Decide-TB_Euler_TDA-A_yesNS.pdf", width = 11)
...
```{r}
pdf("/Users/leylasophielarsson/Desktop/Studies/Decide-TB/Plots/Decide-TB_Euler_TDA-B_yesNS.pdf", width = 11)
